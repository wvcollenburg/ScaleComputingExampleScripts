...
Script to demonstrate exporting vm's based on a tag
...
$smbdomain = "mydomain.local"                       # The domain for the SMB user. usually your windows domain
$smbuser = "administrator"                          # Username that has write and change rights on the SMB share
$smbpassword = "MyS3cret"                           # Password for given user
$smburl = "fileserver.mydomain.local"               # IP Address or FQDN for SMB share
